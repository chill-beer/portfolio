...
- **안정성** — Android 사용자 인지 비정상 종료율 약 77% 감소 (입사 시점 2024.09 약 2.7% → 0.62%)
...
- **앱 안정성 (마이비)** — 외주로 급히 런칭된 초기 앱을 인하우스 체제로 전환하며 안정화. Android 사용자 인지 비정상 종료율 약 77%↓ (입사 시점 2024.09 약 2.7% → 0.62%), 동종 앱 중앙값 수준 안착.
